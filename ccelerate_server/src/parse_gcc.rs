...
#[test]
fn test_gcc_compile_translation_unit_task() {
    let raw_args = vec![
        "-DHAVE_EXECINFO_H",
    ...
    assert_eq!(
        args.user_includes,
        vec![
            PathBuf::from("/home/jacques/blender/blender/source/blender/makesdna"),
            PathBuf::from(
                "/home/jacques/Documents/ccelerate_test/build_blender/source/blender/makesdna/intern"
            ),
            PathBuf::from("/home/jacques/blender/blender/source/blender/blenlib"),
            PathBuf::from("/home/jacques/blender/blender/source/blender/imbuf"),
            PathBuf::from("/home/jacques/blender/blender/source/blender/imbuf/movie"),
            PathBuf::from("/home/jacques/blender/blender/intern/atomic/."),
            PathBuf::from("/home/jacques/blender/blender/intern/guardedalloc"),
            PathBuf::from("/home/jacques/blender/blender/extern/fmtlib/include"),
        ]
    );
    assert_eq!(
        args.system_includes,
    ...
    assert_eq!(
        args.defines,
        vec![
            "HAVE_EXECINFO_H".to_string(),
            "HAVE_MALLOC_STATS_H".to_string(),
            "NDEBUG".to_string(),
            "WITH_ASSERT_ABORT".to_string(),
            "WITH_DNA_GHASH".to_string(),
            "WITH_FREESTYLE".to_string(),
            "WITH_GHOST_WAYLAND_LIBDECOR".to_string(),
            "WITH_TBB".to_string(),
            "_FILE_OFFSET_BITS=64".to_string(),
            "_LARGEFILE64_SOURCE".to_string(),
            "_LARGEFILE_SOURCE".to_string(),
            "__LITTLE_ENDIAN__".to_string(),
            "NDEBUG".to_string(),
        ]
    );
